		...
		<th>OVERTIME HOURS</th>
			...
			if ($results) {
				...
				foreach ($results as $key => $value) {
					...
					$output .= "
					<tr>
                                <td  style='width:200px;'><span style='font-size:14px;'><strong>$count. $name</strong></span></td>
                            <td style='width:200px;'><span style='font-size:14px;'>$pupose</span></td>
                            <td style='width:200px;'><span style='font-size:14px;'>
							<ul>Weekdays, 5:00PM to 12MN.</ul>
							<ul>Saturdays, Sundays and Holidays 5AM to 12MN.</ul>
							</span></td>
                              </tr>";
